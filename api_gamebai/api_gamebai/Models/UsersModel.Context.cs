...
namespace api_gamebai.Models
{
    ...
    public partial class Databasegamebai : DbContext
    {
        ...
        public virtual int ChangePassword(Nullable<int> id, string repass)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ChangePassword", idParameter, repassParameter);
        }
    }
}
