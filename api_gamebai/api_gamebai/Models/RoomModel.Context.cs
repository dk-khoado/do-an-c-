...
namespace api_gamebai.Models
{
    ...
    public partial class DatabaseGameBai_Room : DbContext
    {
        ...
        public virtual int addRoomList(Nullable<int> owner_id, Nullable<int> limit_player, string password, string room_name, Nullable<decimal> bet_money, Nullable<int> id_bai)
        {
            ...
            var bet_moneyParameter = bet_money.HasValue ?
                new ObjectParameter("bet_money", bet_money) :
                new ObjectParameter("bet_money", typeof(decimal));
    
            var id_baiParameter = id_bai.HasValue ?
                new ObjectParameter("id_bai", id_bai) :
                new ObjectParameter("id_bai", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("addRoomList", owner_idParameter, limit_playerParameter, passwordParameter, room_nameParameter, bet_moneyParameter, id_baiParameter);
        }
